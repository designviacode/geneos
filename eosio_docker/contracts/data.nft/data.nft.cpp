...
void nft::subscribe(account_name authorizer,
                  account_name to,
                  id_type id,
                  string memo)
{
   ...
   // Ensure spender can spend token
   eosio_assert(sender_token->owner == authorizer || sender_token->spender == authorizer, "spender not authorized to license this token");
...
EOSIO_ABI(nft, (create)(issue)(transfer)(approve)(transferfrom)(subscribe)(setrampayer)(burn))
