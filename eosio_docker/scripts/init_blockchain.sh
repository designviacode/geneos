...
cleos set account permission  active '{"threshold": 1,"keys": [{"key": "EOS7eKPuMkR8tPLwqgokK2T7qwPM1RmyigyqqH89LkoyMXspZSr7Y","weight": 1}],"accounts": [{"permission":{"actor":"marketplace","permission":"eosio.code"},"weight":1}]}' owner -p marketplace@ownermarketplace
